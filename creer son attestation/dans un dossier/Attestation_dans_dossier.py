...
files = [r'Attestation.pdf',r'qrcode.png']
target = r'Create_Attestaion_done'
...
print('')    
print(file,' déplacé dans le dossier \'Create_Attestaion_done\'')
print('')
print('Veuillez trouver à la fin de l\'éxecution du script, votre Attestation et votre qrcode dans le dossier -> Py\Create_Attestation\Create_Attestation_done')
time.sleep(15)
